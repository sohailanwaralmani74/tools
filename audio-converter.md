  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        ...
        {
          "@type": "Question",
          "name": "Is there a limit on file size?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Since it's handled by your browser, the limit depends on your system's memory and browser capabilities — not our servers."
          }
        }
      ]
    },
...
<div id="main-container" style="width:100%; min-height: 88vh;">

    <div style="display: flex; justify-content: center; margin-top: 2rem; width: 100%;">
        <label for="audio-file" class="upload-label" >Upload File</label>
        <input type="file" id="audio-file" accept="audio/*" style="display: none;">
    </div>
    <div id="loader" style="display:none;">⏳ Processing file...</div>
    <div id="fileInfo" style="font-family: Georgia; background-color: #f4f4f4; border-left: 4px solid #4caf50;width: 90%; min-height: 12rem; margin-left: 2rem; margin-top: 4rem; display: none;justify-content: flex-start; ">
...
<section>
  <h1>Convert MP3, WAV, FLAC, M4A, and More Instantly</h1>
</section>
<section>
  <p>
Looking for a fast, secure, and hassle-free way to convert audio files? This all-in-one <strong>audio converter</strong> supports 12 popular formats including MP3, WAV, FLAC, AAC, M4A, OGG, and more — all working directly in your browser. Whether you're converting a voice recording, podcast, music file, or ringtone, our tool makes it effortless. Just upload your file and choose your output format — no installation, no file size limits, no waiting.
</p>
